...
var Cirque = function(options) {
  ...
  this.options ={
    ...
    shadedRings: options.shadedRings !== undefined && options.shadedRings !== null ? options.shadedRings : true,
...
Cirque.prototype = {
  ...
  _renderPath: function(percent, radius, color, shade) {
    ...
    this._createEl('circle', {
      ...
      cy: this.center.y,
      r: radius,
      fill: this.options.shadedRings ? shade : (this.options.baseColor || this.options.baseColor)
    }, this.element);
